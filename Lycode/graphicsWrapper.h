...
#ifdef _WIN32
	inline void __stdcall hideConsole() { ::ShowWindow(::GetConsoleWindow(), SW_HIDE); }
	inline void __stdcall showConsole() { ::ShowWindow(::GetConsoleWindow(), SW_SHOW); }
	inline bool __stdcall isConsoleVisible() { return ::IsWindowVisible(::GetConsoleWindow()) != FALSE; }
#endif
